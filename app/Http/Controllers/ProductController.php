...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('backend.product.products.create', compact('categories','sellers'));
    }
    ...
    {
        //   dd($request->seller_id, $request->all());
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->get();
        $type = 'In House';
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang', 'type','sellers'));
    }
    ...
    public function productlimitcreate()
    {
        return view('backend.product.product_limit.product_limit');
    }
    
    public function productlimitstore(Request $request)
    {
        $request->validate([
