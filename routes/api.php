...
Route::withoutMiddleware([
    ...
    Route::match(['get', 'post'], 'v2/shipping/tracking-callback', [AdminShiprocketController::class, 'webhook'])
        ->name('api.shipping.tracking_callback');
    Route::match(['get', 'post'], 'v2/shiprocket/webhook', [AdminShiprocketController::class, 'webhook'])
...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::group(['middleware' => ['app_user_unbanned']], function () {
        ...
        Route::get('order/shiprocket-tracking/{id}', 'App\Http\Controllers\Api\V2\OrderController@shiprocket_tracking')->middleware('auth:sanctum');
