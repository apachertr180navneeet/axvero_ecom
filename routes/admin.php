...
use App\Http\Controllers\BulkBuyerController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::get('/product-limit/create', 'productlimitcreate')->name('product_limit.create');
        Route::post('/product-limit/store', 'productlimitstore')->name('product_limit.store');
    ...
    Route::controller(SellerController::class)->group(function () {
        ...
        Route::get('/sellers-export','export')->name('sellers.export');
    });
    ...
    Route::get('join-agent',[CustomerController::class,'joinAgent'])->name('join-agent');

    // Bulk Buyer Management
    Route::middleware(['permission:manage_bulk_buyers'])->group(function () {
        Route::controller(BulkBuyerController::class)->group(function () {
            Route::get('/bulk-buyers', 'index')->name('bulk_buyers.index');
            Route::get('/bulk-buyers/customers', 'customers')->name('bulk_buyers.customers');
            Route::get('/bulk-buyers/{id}', 'show')->name('bulk_buyers.show');
            Route::post('/bulk-buyers/make/{id}', 'makeBulkBuyer')->name('bulk_buyers.make');
            Route::post('/bulk-buyers/remove/{id}', 'removeBulkBuyer')->name('bulk_buyers.remove');
            Route::post('/bulk-buyers/mark-cod-paid/{order_id}', 'markCodPaid')->name('bulk_buyers.mark_cod_paid');
        });
    });
