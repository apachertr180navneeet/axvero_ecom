...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    Route::controller(AffiliateController::class)->group(function () {
        ...
        Route::get('/affiliate/users/show_verification_request/{id}', 'show_verification_request')->name('affiliate.users.show_verification_request');
        Route::get('/affiliate/users/approve/{id}', 'approve_user')->name('affiliate.users.approve');
        Route::get('/affiliate/users/reject/{id}', 'reject_user')->name('affiliate.users.reject');
        ...
        Route::post('/affiliate/payment_store', 'payment_store')->name('affiliate.payment_store');
        Route::get('/affiliate/payment_history/{id}', 'payment_history')->name('affiliate.payment_history');
        ...
        Route::post('/affiliate/withdraw_modal', 'affiliate_withdraw_modal')->name('affiliate.withdraw_modal');
        Route::post('/affiliate/withdraw_request_payment_store', 'withdraw_request_payment_store')->name('affiliate.withdraw_request_payment_store');
