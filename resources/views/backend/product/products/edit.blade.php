...
<div class="page-content">
    ...
    <select class="form-control" id="product_type" name="product_type" onchange="toggleSeller()">
        <option value="admin" {{ $product->added_by == 'admin' ? 'selected' : '' }}>Inhouse</option>
        <option value="seller" {{ $product->added_by == 'seller' ? 'selected' : '' }}>Seller</option>
    </select>
</div>

<div class="form-group mb-2" id="seller_block" style="{{ $product->added_by == 'seller' ? '' : 'display:none;' }}">
        ...
        @endforeach
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xxl-9">
                                        <input type="number" name="agent_discount" value="{{ $product->agent_discount }}" min="0" step="0.01" class="form-control">
                                    </div>
                                </div>
                                <!-- Discount Type -->
                                <div class="form-group row">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group mb-2">
                                    <label class="col-from-label">
                                        {{ translate('Online Payment Discount') }}
                                    </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="number"
                                                   step="0.01"
                                                   min="0"
                                                   name="online_pay_discount"
                                                   class="form-control"
                                                   placeholder="{{ translate('Online Pay Discount') }}"
                                                   value="{{ old('online_pay_discount', $product->online_pay_discount ?? 0) }}">
                                        </div>
                                
                                        <div class="col-md-3">
                                            <select class="form-control aiz-selectpicker"
                                                    name="online_pay_discount_type">
                                                <option value="amount"
                                                    {{ ($product->online_pay_discount_type ?? 'amount') == 'amount' ? 'selected' : '' }}>
                                                    {{ translate('Flat') }}
                                                </option>
                                                <option value="percent"
                                                    {{ ($product->online_pay_discount_type ?? '') == 'percent' ? 'selected' : '' }}>
                                                    {{ translate('Percent') }}
                                                </option>
                                            </select>
                                        </div>
