...
<div class="page-content">
    ...
    <label class="col-from-label fs-13">Product Type</label>

    <select class="form-control" id="product_type" name="product_type" onchange="toggleSeller()">
        <option value="">Select Product Type</option>
        <option value="admin">Inhouse</option>
        <option value="seller">Seller</option>
    </select>

</div>

<div class="form-group mb-2" id="seller_block" style="display:none;">
    <label class="col-from-label fs-13">Select Seller</label>
        ...
        @endforeach
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                   ...
                                   <!--Agent  Discount -->
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Agent Discount')}}(%)</label>
                                    <div class="col-xxl-9">
                                        <input type="number" name="agent_discount" value="0" min="0" step="0.01" class="form-control">
                                    </div>
                                </div>
                                <!-- Discount Type -->
                                <div class="form-group row">
                    ...
                    <div class="tab-pane fade" id="price_and_stocks" role="tabpanel" aria-labelledby="price-and-stocks-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group mb-2">
                                    <label class="col-from-label">{{translate('Online Pay Discount')}}</label>
                                    <div class="row">
                                        <div class="col-md-9">
                                            <input type="number" lang="en" min="0" value="{{ old('online_pay_discount', 0) }}" step="0.01" placeholder="{{ translate('Online Pay Discount') }}" name="online_pay_discount" class="form-control @error('online_pay_discount') is-invalid @enderror">
                                        </div>
                                        <div class="col-md-3">
                                            <select class="form-control aiz-selectpicker" name="online_pay_discount_type">
                                                <option value="amount" @selected(old('online_pay_discount_type') == 'amount')>{{translate('Flat')}}</option>
                                                <option value="percent" @selected(old('online_pay_discount_type') == 'percent')>{{translate('Percent')}}</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane fade" id="shipping" role="tabpanel" aria-labelledby="shipping-tab">
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Shipping Details')}}</label>
                                    <div class="col-md-9">
<textarea class="form-control"
          name="shipping_description"
          rows="4"
          placeholder="Enter shipping details...">{{ old('shipping_description') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">Return Policy</label>
                                    <div class="col-md-9">
<textarea class="form-control"
          name="return_description"
          rows="4"
          placeholder="Enter Return Policy...">{{ old('return_description') }}</textarea>
                                    </div>
                                </div>
...
function toggleSeller(){
    ...
    const sellerBlock = document.getElementById("seller_block");

    if(type === "seller"){
        sellerBlock.style.display = "block";
    }else{
