            ...
            <div class="col-lg-6 col">
                <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                    ...
                    @if (get_setting('show_currency_switcher') == 'on')
                        <li class="list-inline-item dropdown ml-auto ml-lg-0 mr-3 currency-visibility"
                            id="currency-change">
                            @php
                ...
                <div class="d-none d-xl-block ml-auto mr-0">
                    ...
                    @else
                        ...
                        <span class="d-flex align-items-center ml-3">
                            ...
                            <a href="{{ route('user.login') }}"
                                class="d-none d-md-inline-block opacity-60 hov-opacity-100 fs-12 border-right border-soft-light border-width-2 pr-2 ml-3 middle-text-color-visibility"
                                style="color: {{ $middleHeaderTextColor }}">{{ translate('Login') }}</a>
                            <a href="{{ route('user.registration') }}"
                                class="d-none d-md-inline-block opacity-60 hov-opacity-100 fs-12 py-2 pl-2 middle-text-color-visibility"
