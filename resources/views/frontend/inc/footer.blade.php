        ...
        <div class="row no-gutters border-left border-soft-light">
            ...
            <div class="col-lg-3 col-6 policy-file">
                <a class="text-reset h-100  border-right border-bottom border-soft-light text-center p-2 p-md-4 d-block hov-ls-1" href="{{ route('supportpolicy') }}">
                    ...
                    <!--    </g>-->
                    <!--</svg>-->
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#919199" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <!-- Head -->
  <circle cx="12" cy="7" r="4"/>
  <!-- Body -->
  <path d="M6 21v-2a6 6 0 0 1 12 0v2"/>
  <!-- Info/Document box -->
  <rect x="16" y="4" width="6" height="6" rx="1" ry="1" fill="none" stroke="#919199"/>
  <line x1="17" y1="6" x2="21" y2="6" stroke="#919199"/>
  <line x1="17" y1="8" x2="21" y2="8" stroke="#919199"/>
</svg>

                    <h4 class="text-dark fs-14 fw-700 mt-3">{{ translate('About us') }}</h4>
                </a>
            </div>
