    ...
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <div class="p-4 text-center mb-4 border-bottom position-relative">
            ...
            @if ($user->is_bulk_buyer)
                <span class="badge badge-success mb-2" style="font-size: 10px;">Bulk Buyer</span>
            @endif
            <!-- Phone -->
            @if ($user->phone != null)
        ...
        <div class="sidemnenu">
                ...
                @if (optional(Auth::user())->user_type == 'affiliate')
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('affiliate.user.index') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.user.index']) }}">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('affiliate.user.payment_history') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.user.payment_history']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('affiliate.user.withdraw_request_history') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.user.withdraw_request_history']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('preorder.order_list') }}"
                                        class="aiz-side-nav-link {{ areActiveRoutes(['preorder.order_list', 'purchase_history.details']) }}">
                                ...
                                @if (get_setting('conversation_system') == 1)
                                    ...
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('preorder-conversations.customer-index') }}"
                                            ...
                                            <span
                                                class="aiz-side-nav-text">{{ translate('Preorder Conversations') }}</span>
            ...
            <!-- logout -->
            <a href="{{ route('logout') }}"
                class="modern-btn modern-btn-primary w-100 fs-14 fw-700 mb-5 mb-md-0">{{ translate('Sign Out') }}</a>
        </div>
