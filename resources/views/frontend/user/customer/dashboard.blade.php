...
@section('panel_content')
    ...
    <div class="row gutters-16">
            ...
            <div class="col-xl-8 col-md-6 mb-4">
                <div class="h-100"
                    ...
                    <div class="p-4 h-100 w-100 w-xl-50">
                        ...
                        <button class="btn btn-block border border-soft-light hov-bg-dark text-white mt-4 mb-2 py-3"
                        ...
                        <a href="javascript:void(0);" class="fs-14 fw-400 text-white mb-3"
        ...
        <div class="col mb-4">
            <div class="h-100">
                <div class="row h-100 @if (get_setting('wallet_system') != 1) row-cols-md-2 @endif row-cols-1">
                    <!-- Expenditure summary -->
                    <div class="col">
                        <div class="p-4" style="margin-bottom: 2rem; background: #d43533;">
                    ...
                    <!-- Club Point summary -->
                    <div class="col">
                        <div class="p-4" style="background: #85b567;">
                            <div class="d-flex align-items-center pb-4 ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                                    <g id="Group_25000" data-name="Group 25000" transform="translate(-926 -614)">
                                        <rect id="Rectangle_18646" data-name="Rectangle 18646" width="48" height="48"
                ...
                @if (Auth::user()->addresses != null)
                    ...
                    @if ($address != null)
                        <ul class="list-unstyled mb-5">
                            ...
                            <li class="fs-14 fw-400 text-derk pb-1"><span>
                                    {{ $address->area ? $address->area->name . ',' : '' }}</span></li>
                            ...
                            <li class="fs-14 fw-400 text-derk pb-1">
                                <span>{{ $address->state ? $address->state->name : '' }}</span></li>
                    ...
                    <div class="aiz-card-box col py-3 text-center border-right border-bottom has-transition hov-shadow-out z-1"
                        ...
                        <div class="position-relative h-140px h-md-200px img-fit overflow-hidden mb-3">
                            ...
                            <a href="{{ route('product', $wishlist->product->slug) }}"
                                class="d-block h-100 position-relative image-hover-effect">
                                <img src="{{ uploaded_asset($wishlist->product->thumbnail_img) }}"
                                    class="lazyload mx-auto img-fit product-main-image"
                            ...
                            <!-- add to cart -->
                            @php
                                $colors = is_string($wishlist->product->colors)
                                    ? json_decode($wishlist->product->colors, true)
                                    : $wishlist->product->colors;
                                $attributes = is_string($wishlist->product->attributes)
                                    ? json_decode($wishlist->product->attributes, true)
                            ...
                            @else
                                <a class="cart-btn absolute-bottom-left w-100 h-35px aiz-p-hov-icon text-white fs-13 fw-700 d-none d-sm-flex flex-column justify-content-center align-items-center"
                                    ...
                                    @if (Auth::check() || get_Setting('guest_checkout_activation') == 1) onclick="addToCartSingleProduct({{ $wishlist->product->id }})" @else onclick="showLoginModal()" @endif>
                                    <span class="cart-btn-text">
